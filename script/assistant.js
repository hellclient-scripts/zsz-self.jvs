...
function quick_start(){
    ...
    var initdata={
        ...
        "num_step":"6",
        "num_tuna":"50",
        "list_assist":"cha|score|hp|#login"
    }
    for (var key in initdata) {
        world.Note("设置变量 "+key+" 为 " +initdata[key])
        world.SetVariable(key,initdata[key])
   ...
   function prompt_exp_max(){
    var list=Userinput.newlist("最大EXP","请选择你需要设置的最大EXP",false)
        list.append("99699","99699 npc lv 60 Shot")
        list.append("149699","149699 npc lv 60 Shot上限，命中下降")
        list.append("199699","199699 npc lv 80 使用Pfm")
        list.append("399699","399699 npc lv 100")
        list.append("699699","699699 npc lv 125,无西域，补技能到191和知识类")
        list.append("799699","799699 npc lv 125")
        list.append("1199699","1199699 npc lv 150")
        list.append("1599699","1599699 npc lv 175")
        list.append("1999699","1999699 npc lv 200")
        list.append("2499699","2499699 npc lv 225")
        list.append("2699699","2699699 npc lv 250,closed过火浪")
        list.append("2999699","2999699 npc lv 275")
        list.append("4999699","4999699 npc lv 300")
        list.append("7499699","7499699 npc lv 350")
        list.append("8999699","8999699 npc lv 400")
        list.append("14999699","14999699 npc lv 450")
        list.append("19999699","19999699 npc lv 500")
        list.append("24999699","24999699 npc lv 550")
        list.append("32999699","32999699 npc lv 600")
        list.append("37999699","37999699 npc lv 650")
        list.append("41999699","41999699 npc lv 700")
        list.append("44999699","44999699 npc lv 725")
        list.append("53999699","53999699 npc lv 750")
        list.append("59999699","59999699 npc lv 800")
        list.append("64999699","64999699 npc lv 825")
        list.append("69999699","69999699 npc lv 855")
        list.append("74999699","74999699 npc lv 875")
        list.append("89999699","89999699 npc lv 900")
